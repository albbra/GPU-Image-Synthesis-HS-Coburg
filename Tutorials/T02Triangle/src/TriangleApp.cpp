...
private:
  ...
  void createPipeline()
  {
    const auto vertexShader =
        compileShader(L"../../../Tutorials/T02Triangle/Shaders/Triangle.hlsl", L"VS_main", L"vs_6_0");
    
    const auto pixelShader =
        compileShader(L"../../../Tutorials/T02Triangle/Shaders/Triangle.hlsl", L"PS_main", L"ps_6_0");
...
int main(int /* argc*/, char /* **argv */)
{
  ...
  config.title    = L"Tutorial 02 Triangle";
